...
<tools>
{"type":"function","function":{"name":"crop_image","description":"Crops an image, specified by its index, to a region defined by a bounding box (bbox).","parameters":{"type":"object","properties":{"bbox_2d":{"type":"array","description":"The bounding box [x1, y1, x2, y2] defining the region to crop. Coordinates are absolute pixel values, where (x1, y1) is the top-left corner and (x2, y2) is the bottom-right corner.","items":{"type":"integer"},"minItems":4,"maxItems":4},"image_index":{"type":"integer","description":"A 0-based index specifying which image to crop.","minimum":0}},"required":["bbox_2d","image_index"]}}}
